...
<ul id="site-map-root">
    <li id="page_root" class="node level-0">
      <div class="page" style="padding-left: 4px">
        <span class="w1">
          <a href="<?php echo get_url('page/edit/1'); ?>" title="/"><img align="center" alt="page-icon" class="icon" src="images/page.png" title="" /> <span class="title"><?php echo $root->title; ?></span></a>
        </span>
      </div>
      <div class="status published-status"><?php echo __('Published') ?></div>
      <div class="modify">
          <a href="<?php echo get_url('page/add/1'); ?>"><img alt="<?php echo __('Add child') ?>" src="images/add-child.png" /></a></td>
