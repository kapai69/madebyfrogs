...
<?php foreach($snippets as $snippet): ?>
    ...
    <tr class="node <?php echo odd_even() ?>">
      ...
      <td class="remove"><a href="<?php echo get_url('snippet/delete/'.$snippet->id) ?>" onclick="return confirm('<?php echo __('Are you sure you wish to delete') ?> <?php echo $snippet->name ?>?');"><img alt="<?php echo __('Remove Snippet') ?>" src="images/remove.png" /></a></td>
    </tr>
...
<p><a href="<?php echo get_url('snippet/add') ?>"><img alt="<?php echo __('Add Snippet') ?>" src="images/new-snippet.png" /></a></p>