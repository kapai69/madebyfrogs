...
<?php foreach($layouts as $layout) { ?>
    ...
    <tr class="node <?php echo odd_even() ?>">
      ...
      <td class="remove"><a href="<?php echo get_url('layouts/delete/'.$layout->id) ?>" onclick="return confirm('<?php echo __('Are you sure you wish to delete') ?> <?php echo $layout->name ?>?');"><img alt="<?php echo __('Remove Layout') ?>" src="images/remove.png" /></a></td>
    </tr>
...
<p><a href="<?php echo get_url('layouts/add') ?>"><img alt="<?php echo __('Add Layout') ?>" src="images/new-layout.png" /></a></p>