...
class PDOPgsql
{
    ...
    {
        return new PDOStatementPgsql($query, $this->_connection, $this->_dbinfo);
    }
...
/**
 * PDOStatement adpater for PostgreSQL
 *
 * For more specification on methods of this class check the PDO class
 * can be find on the same directory at PDO.php
 *
 */
class PDOStatementPgsql extends PDOStatement
{
