...
(1, 'body', 'Textile', 'Homepage content with "Textile":http://www.textism.com/tools/textile/ filter', '	<p>Homepage content with <a href="http://www.textism.com/tools/textile/">Textile</a> filter</p>', 1),
...
INSERT INTO `{TABLEPREFIX}page` (`id`, `title`, `slug`, `breadcrumb`, `parent_id`, `layout_id`, `behavior_id`, `status_id`, `created_on`, `updated_on`, `created_by_id`, `updated_by_id`) VALUES 
(1, 'Home', '', 'Home', 0, 2, '', 100, '{DATETIME}', '{DATETIME}', 1, 1),
(2, 'Styles', 'styles.css', 'Styles', 1, 3, '', 101, '{DATETIME}', '{DATETIME}', 1, 1),
(3, 'About us', 'about_us', 'About us', 1, 0, '', 100, '{DATETIME}', '{DATETIME}', 1, 1),
(4, 'Articles', 'articles', 'Articles', 1, 0, '', 100, '{DATETIME}', '{DATETIME}', 1, 1),
(5, 'My first article', 'articles/my_first_article', 'My first article', 4, 0, '', 100, '{DATETIME}', '{DATETIME}', 1, 1),
(6, 'My second article', 'articles/my_second_article', 'My second article', 4, 0, '', 100, '{DATETIME}', '{DATETIME}', 1, 1);
