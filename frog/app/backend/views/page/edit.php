              ...
              <?php if (isset($page->created_on)): ?>
                <tr>
                  ...
                  <td class="field">
                    ...
                    <img onclick="displayDatePicker('page[created_on]');" src="app/backend/assets/images/icon_cal.gif" alt="<?php echo __('Show Calendar'); ?>" /> 
                ...
                <?php if (isset($page->published_on)): ?>
                    ...
                    <img onclick="displayDatePicker('page[published_on]');" src="app/backend/assets/images/icon_cal.gif" alt="<?php echo __('Show Calendar'); ?>" />
    ...
    <div id="tab-control" class="tab_control">
      <div id="tabs" class="tabs">
        <div id="tab-toolbar" class="tab_toolbar">
          <a href="#" onclick="toggle_popup('add-part-popup', 'part-name-field'); return false;" title="<?php echo __('Add Tab'); ?>"><img src="app/backend/assets/images/plus.png" alt="plus icon" /></a>
          <a href="#" onclick="if (confirm('<?php echo __('Delete the current tab?'); ?>')) { tabControl.removeTab(tabControl.selected) }; return false;" title="<?php echo __('Remove Tab'); ?>"><img src="app/backend/assets/images/minus.png" alt="minus icon" /></a>
        </div>
      </div>
...
<div id="popups">
  <div class="popup" id="add-part-popup" style="display: none;">
    <div id="busy" class="busy" style="display: none;"><img alt="Spinner" src="app/backend/assets/images/spinner.gif" /></div>
