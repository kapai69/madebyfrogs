...
class DoLite
{
    ...
    public function __construct($dsn , $username=null, $password=null, $driver_options=null)
    {
        ...
        if ($conn['dbtype'] == 'mysql') {
            require_once CORE_ROOT . 'libraries/DoLiteDrivers/DoMysql.php';
            if (isset($conn['port'])) {
                $conn['host'] .= ':'.$conn['port'];
            }
        ...
        // SQLite connexion
            ...
            require_once CORE_ROOT . 'libraries/DoLiteDrivers/DoSqlite.php';
            $this->_adapter = new DoSqlite($conn['dbname']);
            
        // postgreSQL connexion
        } else if ($conn['dbtype'] == 'pgsql') {
            require_once CORE_ROOT . 'libraries/DoLiteDrivers/DoPgsql.php';
