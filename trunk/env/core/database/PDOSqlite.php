...
class PDOSqlite
{
    ...
    {
        return new PDOStatementSqlite($query, $this->_connection, $this->_dbinfo);
    }
...
} // End PDO_Sqlite class



/**
 * PDOStatement adpater for Sqlite
 *
 * For more specification on methods of this class check the PDO class
 * can be find on the same directory at PDO.php
 *
